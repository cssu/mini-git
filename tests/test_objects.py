...
def test_hash_object_cli_print(tmp_path, capsys):
    ...
    # Placeholder contract: CRC32-based 8-digit lowercase hex
    # TODO: Update this test when we implement real SHA-1 hashing in Week 2.
    assert len(obj_hash) == 8  # SHA-1 hash length of 40
